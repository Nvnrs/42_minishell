...
/*   Updated: 2025/03/11 15:17:10 by nveneros         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		single_quote_case(char *str, char *newstr,
				int *i_str, int *i_newstr);
void		double_quote_case(char *str, char *newstr,
				int *i_str, int *i_newstr);
